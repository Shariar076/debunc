...
if __name__ == "__main__":
    ...
    print("Total question_data:", len(question_data))
    question_data = question_data[:5]
    print("Using question_data:", len(question_data))
        ...
        for i, q_data in enumerate(tqdm(question_data)):
            ...
            for round in range(rounds):
                ...
                json.dump(
                    all_trial_data,
                    open(
                        f"truth_{agents}_{rounds}_{trials}_attention_all_{ue_method.__class__.__name__}.json",
                        "w",
                    ),
                    cls=RWJSONEncoder,
                )
